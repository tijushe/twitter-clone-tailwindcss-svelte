...
<main class="bg-grey-light font-sans">
	<div class="bg-white">
		<div class="container mx-auto flex flex-col lg:flex-row items-center py-4">
			...
			<div class="w-full lg:w-2/5 flex lg:justify-end">
				...
				<div class="mr-4"><img src="/ph/twitter/avatar.jpg" alt="avatar" class="h-8 w-8 rounded-full"/></div>
	...
	<div class="bg-white shadow">
		<div class="container mx-auto flex flex-col lg:flex-row items-center lg:relative">
			<div class="w-full lg:w-1/4">
				<img src="/ph/twitter/tailwind_logo.jpg" alt="logo" class="rounded-full h-48 w-48 lg:absolute lg:pin-l lg:pin-t lg:-mt-24"/>
			</div>
	...
	<div class="container mx-auto flex flex-col lg:flex-row mt-3 text-sm leading-normal">
		<div class="w-full lg:w-1/4 pl-4 lg:pl-0 pr-6 mt-8 mb-4">
			...
			<div class="mb-4">
				<a href="#/"><img src="/ph/twitter/follower01.jpg" alt="avatar" class="rounded-full h-12 w-12"/></a>
				<a href="#/"><img src="/ph/twitter/follower02.jpg" alt="avatar" class="rounded-full h-12 w-12"/></a>
				<a href="#/"><img src="/ph/twitter/follower03.jpg" alt="avatar" class="rounded-full h-12 w-12"/></a>
				<a href="#/"><img src="/ph/twitter/follower04.jpg" alt="avatar" class="rounded-full h-12 w-12"/></a>
				<a href="#/"><img src="/ph/twitter/follower05.jpg" alt="avatar" class="rounded-full h-12 w-12"/></a>
				<a href="#/"><img src="/ph/twitter/follower06.jpg" alt="avatar" class="rounded-full h-12 w-12"/></a>
				<a href="#/"><img src="/ph/twitter/follower07.jpg" alt="avatar" class="rounded-full h-12 w-12"/></a>
				<a href="#/"><img src="/ph/twitter/follower08.jpg" alt="avatar" class="rounded-full h-12 w-12"/></a>
				<a href="#/"><img src="/ph/twitter/follower09.jpg" alt="avatar" class="rounded-full h-12 w-12"/></a>
				<a href="#/"><img src="/ph/twitter/follower10.jpg" alt="avatar" class="rounded-full h-12 w-12"/></a>
			</div>

			<div class="mb-4"><i class="fa fa-picture-o fa-lg text-grey-dark mr-1"></i><a href="#/">Photos and videos</a></div>

			<!-- <div class="mb-4">
				<img src="/ph/twitter/photo1.jpg" alt="photo" class="h-20 w-20 mr-1 mb-1"/>
				<img src="/ph/twitter/photo2.jpg" alt="photo" class="h-20 w-20 mr-1 mb-1"/>
				<img src="/ph/twitter/photo3.jpg" alt="photo" class="h-20 w-20 mr-1 mb-1"/>
				<img src="/ph/twitter/photo4.jpg" alt="photo" class="h-20 w-20 mr-1 mb-1"/>
				<img src="/phimg/twitter/photo5.jpg" alt="photo" class="h-20 w-20 mr-1 mb-1"/>
			</div> -->
		</div>
		...
		<div class="w-full lg:w-1/2 bg-white mb-4">
			...
			<div class="flex border-b border-solid border-grey-light">
				<div class="w-1/8 text-right pl-3 pt-3">
					...
					<div><a href="#/"><img src="/ph/twitter/avatar_tailwind.jpg" alt="avatar" class="rounded-full h-12 w-12 mr-2"/></a></div>
				</div>
				<div class="w-7/8 p-3 pl-0">
					...
					<div class="flex justify-between">
						<div>
							...
							<span class="text-grey-dark">15 Jan 2021</span>
						</div>
						<div>
					...
					<div>
						<div class="mb-4">
							<p class="mb-6">Tailwind CSS v2.0 is out!</p>
							...
							<!-- <p><a href="#/"><img src="/ph/twitter/tweet1.jpg" alt="tweet image" class="border border-solid border-grey-light rounded-sm"/></a></p> -->
						</div>
					</div>
			...
			<div class="flex border-b border-solid border-grey-light">
				...
				<div class="w-1/8 text-right pl-3 pt-3">
					...
					<div><a href="#/"><img src="ph/twitter/avatar_adam.jpg" alt="avatar" class="rounded-full h-12 w-12 mr-2"></a></div>
				</div>
				...
				<div class="w-7/8 p-3 pl-0">
					...
					<div>
						<div class="mb-4">
							...
							<!-- <p><img src="/ph/twitter/tweet2.jpg" alt="tweet image" class="border border-solid border-grey-light rounded-sm"/> -->
						</div>
						<div class="pb-2">
				...
				<div class="w-7/8 p-3 pl-0">
					...
					<div>
						<div class="mb-4">
							...
							<!-- <p><img src="/ph/twitter/tweet3.jpg" alt="tweet image" class="border border-solid border-grey-light rounded-sm"></p> -->
						</div>
						<div class="pb-2">
			...
			<div class="flex border-b border-solid border-grey-light">
				...
				<div class="w-1/8 text-right pl-3 pt-3">
					<div><i class="fa fa-retweet text-grey-dark mr-2"></i></div>
					<div><img src="/ph/twitter/avatar_egghead.jpg" alt="avatar" class="rounded-full h-12 w-12 mr-2"></div>
				</div>
					...
					<div>
						<div class="mb-4">
							...
							<div class="flex border border-solid border-grey-light rounded">
								<div class="w-1/4">
									<!-- <img src="/ph/twitter/tweet4.jpg" alt="image"/> -->
								</div>
								<div class="w-3/4 p-3">
		...
		<div class="w-full lg:w-1/4 pl-4">
			<div class="bg-white p-3 mb-3">
				...
				<div class="flex border-b border-solid border-grey-light">
					<div class="py-2">
						<a href="#/"><img src="/ph/twitter/follow1.jpg" alt="follow1" class="rounded-full h-12 w-12"></a>
					</div>
				...
				<div class="flex border-b border-solid border-grey-light">
					<div class="py-2">
						<a href="#/"><img src="/ph/twitter/follow2.jpg" alt="follow1" class="rounded-full h-12 w-12"></a>
					</div>
					<div class="pl-2 py-2 w-full">
						<div class="flex justify-between mb-1">
							<div>
				...
				<div class="flex border-b border-solid border-grey-light">
					<div class="py-2">
						<a href="#/"><img src="/ph/follow3.jpg" alt="follow1" class="rounded-full h-12 w-12"></a>
					</div>
					<div class="pl-2 py-2 w-full">
						<div class="flex justify-between mb-1">
							<div>
				...
				<div class="flex border-b border-solid border-grey-light">
					<div class="py-4">
						<a href="#/" class=" p-1"><img src="/ph/twitter/outlook.png" alt="follow1" class="rounded h-6 w-6"></a>
					</div>
					<div class="pl-2 py-2 w-full">
						<div class="flex justify-between">
							<div>
